...
const [_1, _2, input, isChecksum, isSuffix] = process.argv;

getVanityWallet(input, isTruthy(isChecksum), isTruthy(isSuffix), console.log);
 ...
 * @returns
 */
function getVanityWallet(input, isChecksum, isSuffix, cb) {
 ...
 * @returns {boolean}
 */
function isValidVanityAddress(address, input, isChecksum, isSuffix) {
...
function isTruthy(val) {
    ...
    return truthyVals.includes(normalizedVal);
}
